...
(function () {
  var css = ''
    + '.nav__burger{display:none;background:none;border:0;padding:0;cursor:pointer;width:28px;height:22px;position:relative;z-index:110;flex-direction:column;justify-content:center;}'
    + '.nav__burger span{display:block;width:100%;height:2px;background:var(--fg,#ede9e1);margin:3px 0;transition:transform .25s ease,opacity .25s ease;}'
    ...
    + '@media(max-width:768px){.nav__links{display:none!important;}.nav__back{display:none!important;}.nav__burger{display:flex;}body.nav-open{overflow:hidden;}}'
